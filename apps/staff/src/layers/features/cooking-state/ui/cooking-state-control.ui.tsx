...
import type { CookingState, OrderLine } from "../../../entities/orders";

type CookingStateControlUIProps = {
  line: OrderLine;
  orderNumber: number;
  editable: boolean;
  disabled: boolean;
  onUpdate: (to: CookingState) => void;
};

export const CookingStateControlUI = ({
  line,
  orderNumber,
  editable,
  disabled,
  onUpdate,
}: CookingStateControlUIProps) => {
