/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 380fd8abb2a9afeb0585ac34c75acc04)
...
interface __BaseEnv_Env {
	...
	OWNER_EMAIL: string;
	STAFF_UPDATES: DurableObjectNamespace<import("./src/index").StaffUpdates>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "StaffUpdates";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "SCHOOL_DOMAIN" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "BETTER_AUTH_SECRET" | "OWNER_EMAIL">> {}
}
